...
Param(
  ...
  [string] $ResourceGroupName = 'MariaDBClusterOnAzure',  
...
#Ensure azure resourcer manager is correct version
...
$AppLocation = "WestUS"
$AppArmTemplate = "C:\Users\keith\OneDrive\Documents\Visual Studio 2015\Projects\MariaDBClusterOnAzure\MariaDBClusterOnAzure\Templates\MariaDBCluster.json"
